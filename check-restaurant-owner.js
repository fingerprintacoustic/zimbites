...
function checkRestaurant() {
    return __awaiter(this, void 0, void 0, function () {
        var dbUrl, connection, restaurants, users;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, mysql.createConnection(dbUrl)];
                case 1:
                    connection = _a.sent();
                    // Get the restaurant owner for restaurant 360001
                    console.log("Querying for restaurant 360002...");
                    return [4 /*yield*/, connection.execute("SELECT id, name, ownerId FROM restaurants WHERE id = 360002")];
                case 2:
                    restaurants = (_a.sent())[0];
                    ...
                    return [4 /*yield*/, connection.execute("SELECT id, openId, role FROM users WHERE id = (SELECT ownerId FROM restaurants WHERE id = 360002)")];
                case 3:
                    users = (_a.sent())[0];
